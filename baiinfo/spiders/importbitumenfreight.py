...
from baiinfo.items import ImportBitumenFreight
import re
import datetime
import logging
import lxml.html
...
class ImportBitumenFreightSpider(scrapy.Spider):
    name = "importbitumenfreight"
    ...
    def parse(self, response):
        self.crawler.stats.set_value('spiderlog/source_name', u'百川资讯-进口沥青船运费价格')
        self.crawler.stats.set_value('spiderlog/target_tables', ['T_BM_BAI_BITUMEN_FREIGHT'])
    ...
    def login_callback(self, response):
        ...
        request = scrapy.http.Request(url='http://www.baiinfo.com/Search/Index/1?wd=%E8%BF%9B%E5%8F%A3%E6%B2%A5%E9%9D%92%E8%88%B9%E8%BF%90%E8%B4%B9%E4%BB%B7%E6%A0%BC', 
            callback = self.parse_index)
        return [request]
#         for i in range(1, 24):
#             request = scrapy.http.Request(url='http://www.baiinfo.com/Search/Index/' + str(i) + '?wd=%E8%BF%9B%E5%8F%A3%E6%B2%A5%E9%9D%92%E8%88%B9%E8%BF%90%E8%B4%B9%E4%BB%B7%E6%A0%BC', 
#                                           callback = self.parse_index)
#             yield request
